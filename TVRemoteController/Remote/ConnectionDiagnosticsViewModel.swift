...
final class ConnectionDiagnosticsViewModel {
    ...
    private func finishDeviceDiagnosis(_ discoveredDevices: [DiscoveredTVDevice]) async {
        if !discoveredDevices.isEmpty {
    ...
    private func upsert(_ device: DiscoveredTVDevice, into devices: inout [DiscoveredTVDevice]) {
