# Quickstart: TV Device Auto Discovery
...
Use `figma-use status` to confirm the current design file, then inspect these frames in `TV Remote Control UI Kit`:
...
- iPhone and TV TV are on the same local network.
- TV TV is awake.
...
5. Confirm the TV TV appears in the discovered-device list.
6. Select the TV.
7. Confirm the connecting state names the selected TV.
8. Confirm the connected-ready state appears.
9. Enter the remote.
10. Confirm the remote header shows the selected TV TV as connected.
