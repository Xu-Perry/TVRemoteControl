...
struct RemoteCommandTests {
    ...
    @Test func validatesIPv4Address() {
        #expect(TVDevice.isValidIPv4Address("192.168.1.10"))
        #expect(!TVDevice.isValidIPv4Address("192.168.1"))
        #expect(!TVDevice.isValidIPv4Address("192.168.1.999"))
        #expect(!TVDevice.isValidIPv4Address("tv.local"))
    }
}
