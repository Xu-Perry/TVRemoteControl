...
public enum TVConnectionReadiness: String, Codable, Equatable, Sendable {
    case connectable
    case paired
    case unavailable
    case unknown
...
public struct DiscoveredTVDevice: Codable, Equatable, Identifiable, Sendable {
    public let id: String
    public var name: String
    public var host: String
    public var port: Int
    public var uniqueIdentifier: String?
    public var connectionReadiness: TVConnectionReadiness
    ...
    public init(
        ...
        connectionReadiness: TVConnectionReadiness = .unknown,
    ...
    public func tvDevice(pskKey: String = "", connectionMode: ConnectionMode = .normalPairing) -> TVDevice {
        TVDevice(
            name: displayName,
            host: host,
            port: port,
